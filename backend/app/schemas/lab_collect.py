...
class SpectrumSampleFileRecord(BaseModel):
    ...
    object_bucket: Optional[str] = Field(default=None, description="对象存储桶名。")
    object_key: Optional[str] = Field(default=None, description="对象存储键。")
    object_uri: Optional[str] = Field(default=None, description="对象存储 URI。")
    object_url: Optional[str] = Field(default=None, description="对象访问 URL。")
